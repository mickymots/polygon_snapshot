...
SNAPSHOT_API = 'https://api.polygon.io/v2/snapshot/locale/us/markets/stocks/tickers/{ticker}?apiKey={apiKey}'
...
def call_snapshot_api(ticker, apiKey):
    url = SNAPSHOT_API.format(ticker=ticker,  apiKey=apiKey )
    return call_service(url)
